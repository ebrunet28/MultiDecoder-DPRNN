...
class ConvTasNet(nn.Module):
    def __init__(self, N, L, B, H, P, X, R, I, C, norm_type="gLN", causal=False,
                 mask_nonlinear='relu'):
        """
        Args:
        ...
        # Hyper-parameter
        self.N, self.L, self.B, self.H, self.P, self.X, self.R, self.I, self.C = N, L, B, H, P, X, R, I, C
        self.norm_type = norm_type
        self.causal = causal
        self.mask_nonlinear = mask_nonlinear
        # Components
        self.encoder = Encoder(I, L, N)
...
class Encoder(nn.Module):
    ...
    def __init__(self, I, L, N):
        ...
        # Components
        # 50% overlap
        self.conv1d_U = nn.Conv1d(I, N, kernel_size=L, stride=L // 2, bias=False)
